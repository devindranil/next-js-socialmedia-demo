    ...
    return (
        <div className='h-24 flex items-center justify-between'>
            ...
            <div className='md:hidden lg:block w-[20%]'>
                <Link className='font-bold text-xl text-blue-600' href="/">YCHSOCIAL</Link>
            </div>
            {/* CENTER   */}
            ...
            {/* RIGHT */}
            <div className=' w-[30%] flex gap-4 items-center xl:gap-8 justify-end'>
                <ClerkLoading>
                    <div role="status">k
                ...
                {/* if loaded check signed in or not */}
                <ClerkLoaded>
                    <SignedIn>
